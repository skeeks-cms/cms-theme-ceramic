                        ...
                        <div class="product-info ss-product-info">
                            ...
                            <div class="product-info-header">
                                ...
                                <div class="product-price g-mt-10 g-mb-10" itemprop="offers" itemscope="" itemtype="http://schema.org/Offer">
                                    ...
                                    <span class="current ss-price h1 g-font-weight-600 g-color-primary"><?= $priceHelper->basePrice->money; ?> </span><? if ($collectionProduct->relatedPropertiesModel->getAttribute('MainUnit')) : ?>
                                        <span class="g-font-weight-600">за 1 <?= $collectionProduct->relatedPropertiesModel->getSmartAttribute('MainUnit'); ?></span><? endif; ?>
                                </div>
                                        ...
                                        <div class="control-group group-submit g-mr-10 g-mb-15">
                                            ...
                                            <? if (\Yii::$app->shop->is_show_quantity_product) : ?>
                                                <div class="availability-row available" style=""><!-- 'available' || 'not-available' || '' -->
                                                    ...
                                                    <? else : ?>
                                                        <span class="row-label">В наличии:</span> <span
                                                                class="row-value"><?= $collectionProduct->shopProduct->quantity; ?><? if ($collectionProduct->relatedPropertiesModel->getAttribute('MainUnit')) : ?> <?= $collectionProduct->relatedPropertiesModel->getSmartAttribute('MainUnit'); ?><? endif; ?></span>
                                                    <? endif; ?>
                            ...
                            <div class="col-lg-8">
                                ...
                                $widgetElements = \skeeks\cms\cmsWidgets\contentElements\ContentElementsCmsWidget::beginWidget("product-collection-products", [
                                    ...
                                    'dataProviderCallback'       => function (\yii\data\ActiveDataProvider $activeDataProvider) use ($collection, $collectionProduct) {
                                        $activeDataProvider->query->leftJoin(\skeeks\cms\themes\ceramic\models\CeramicCollectionMap::tableName().' ceramicMap',
