...
<? if (\Yii::$app->ceramic->is_show_popular_collection) : ?>
    <div class="container g-mt-40 g-mb-40">
        <?
        $widgetElements = \skeeks\cms\cmsWidgets\contentElements\ContentElementsCmsWidget::beginWidget("home-popular-collection1", [
...
<? if (\Yii::$app->ceramic->is_show_new_collection) : ?>
    <div class="container g-mt-40 g-mb-40">
        <?
