...
//skeeks\\cms\\themes\\unifyshop
if ($model->activeChildren) {
    echo $this->render("@skeeks/cms/themes/unifyshop/views/modules/cms/tree/catalog", ["model" => $model]);
    return;
}
...
$widgetElements = \skeeks\cms\cmsWidgets\contentElements\ContentElementsCmsWidget::beginWidget("product-collections", [
    ...
    'dataProviderCallback' => function (\yii\data\ActiveDataProvider $activeDataProvider) use ($model) {
        ...
        $query->andWhere(['p.tree_id' => $model->id]);
                    ...
                    <? endif; ?>
                        ...
                        <div class="col-md-7 order-md-2 g-py-20">
                            ...
                            <div id="portfolio-section">
                                <!-- Heading -->
                                <a href="#" class="sx-btn-filter btn btn-block g-valign-middle text-left">Фильтры <i class="fa fa-angle-down float-right g-pt-5" aria-hidden="true"></i></a>
                                <?
